...
export const demoDescription =
  "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vitae facilis amet eius rerum officia consectetur laudantium quasi ullam autem, sint tenetur dolorum. Tempore aut aspernatur, natus quae quas quia quam.";
export const tourData: Tour[] = [
  {
    ...
    neighborhood: null,
    listingPreviewAmenityNames: ["Self check-in", "Wifi", "Kitchen"],
    previewTags: [],
  ...
  },
  {
    ...
    listingObjType: "REGULAR",
    neighborhood: null,
    listingPreviewAmenityNames: ["Wifi", "Kitchen"],
    previewTags: [],
    publicAddress: "Islamabad, Islamabad Capital Territory, Pakistan",
    reviews: null,
    reviewsCount: 1,
  ...
  },
  {
    ...
    listingObjType: "REGULAR",
    neighborhood: null,
    listingPreviewAmenityNames: ["Wifi"],
    previewTags: [],
    publicAddress: "Islamabad, Islamabad Capital Territory, Pakistan",
    reviews: [],
    reviewsCount: 39,
